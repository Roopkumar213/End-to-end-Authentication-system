      ...
      <div className="container py-5">
        ...
        <div className="row g-4">
          ...
          <div className="col-12 col-md-6">
            <h3 className="fw-bold text-primary mb-3">WebStudio</h3>
          ...
          <div className="col-6 col-md-3">
            <h5 className="text-uppercase fw-semibold mb-3">Quick Links</h5>
            <ul className="list-unstyled">
              <li><Link className="text-muted hover-link d-block mb-1" to="/services">Services</Link></li>
              <li><Link className="text-muted hover-link d-block mb-1" to="/portfolio">Portfolio</Link></li>
              <li><Link className="text-muted hover-link d-block mb-1" to="/about">About</Link></li>
              <li><Link className="text-muted hover-link d-block" to="/contact">Contact</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="col-6 col-md-3">
            <h5 className="text-uppercase fw-semibold mb-3">Contact</h5>
